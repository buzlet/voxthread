// voxthread-004.user.js
// ==UserScript==
// @name         VoxThread Diagnostics
// @namespace    https://github.com/buzlet/voxthread
// @version      0.4.0
// @description  Queue and speak real visible Telegram messages for background tests.
...
(() => {
  ...
  function speakVisibleTelegram() {
    ...
    state.tts = { queued: messages.length, started: 0, ended: 0, errors: [] };
    state.lastBatch = messages.map(({ mid, peerId }) => ({ mid, peerId }));
  ...
  function createPanel() {
    ...
    panel.append(
      ...
      makeButton('Speak Visible', speakVisibleTelegram),
